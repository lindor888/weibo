...
<BODY id="tjdyyh">
	<div class="tjdyyh">
		<dl>
			<form id="appForm" action="/weibo-studio/updateApp.action"
				method="post">
				<center>
				...
				<div id="levelDiv">
					...
					<input class="text" type="radio" name="appLevel" id="appLevel_0"
						value="0" /> <span style="margin-left: 10px;"><em>高级权限：</em></span>
					<input class="text" type="radio" name="appLevel" id="appLevel_1"
						value="1"/>
				</div>
				<input type="hidden" value="${bean.appLevel}" id="appLevelFlag"
					name="bean.appLevel" />
				...
				<dd>
					<input
						...
						id="tj" type="button" onclick="checkApp();" class="submit"
						value="修改" /> <input
						style="background:url(/weibo-studio/style/webcss/img/chaxunbg.jpg)"

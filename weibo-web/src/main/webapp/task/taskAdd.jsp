    ...
    <script type="text/javascript">
    	...
    	var taskType = [9,10,11,12,13,14];//任务类型
      	$(document).ready(function(){ 
        	...
        	myClick();//定时类型选择
        	myClickSecond("1");
        	showXml(taskType[0]);//进入页面显示任务类型的第一个
      	}); 
      ...
      if((timeForever=="" || timeForever.length<=0) && frequencySort != 3){
	   ...
	   if(taskType == taskType[0]) {
		   ...
		   var keyWordArr = keyWord.split(",");
	   		htmlArr.push("<q>");
		   		htmlArr.push(keyWordArr[0]);//关键词为,隔开的多个时，这里暂时先取第一个，后台处理多个关键词问题
	   		htmlArr.push("</q>");
		   if(isNull(startDate)) {
				alert("开始时间不能为空");
				return false;
  ...
  <div id="right">
     <div class="cut1">
	    <div class="block1">
          ...
          <s:form name="mainform" id="mainform" namespace="/task" action="addTask" method="post" theme="simple">
             <input type="hidden" name="bean.weiboId" value="${bean.weiboId }"/>
		    ...
		    <p class="xml xml9"><i>*</i><b>关键词</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		        <span id="point" >
		             <s:textfield name="keyWord" id="keyWord" name="bean.keyWord" theme="simple" maxlength="50"/>&nbsp;<font color='red'>用,隔开添加多个</font>
		        </span>
		     </p>
		     <p class="xml xml9"><i>*</i><b>开始时间</b>&nbsp;&nbsp;&nbsp;&nbsp;
		        <span id="point">
		             <s:textfield name="startDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" id="startDate" theme="simple"/>
		        </span>
		     </p>
		     <p class="xml xml9"><i>*</i><b>结束时间</b>&nbsp;&nbsp;&nbsp;&nbsp;
		        <span id="point">
		             <s:textfield name="endDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" id="endDate" theme="simple"/>
		        </span>
		     </p>
		     <p class="xml xml9"><i>*</i><b>栏目</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		        <span id="point">
		             <s:textfield name="program" id="program" theme="simple" maxlength="32"/>
		        </span>
		     </p>
		     <p class="xml xml10 xml11 xml12 xml13 xml14"><i>*</i><b>微博uid</b>&nbsp;&nbsp;&nbsp;&nbsp;
		        <span id="point">
		             <s:textfield name="uid" id="uid" theme="simple" maxlength="32"/>
		        </span>
		     </p>
	     ...
	     <div class="blank10"></div>
	     <ul class="button_1">
           <li><span onclick="addTimerTask()">添加</span></li>

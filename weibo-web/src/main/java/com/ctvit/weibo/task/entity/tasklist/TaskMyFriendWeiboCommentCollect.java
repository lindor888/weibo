 ...
 *
 */
public class TaskMyFriendWeiboCommentCollect extends Task{
	...
	public void execute(JobExecutionContext context)
		...
		if(flag){
			//通过抓取数据的weiboId从mongodb中查询出未处理微博数据
			List<String> weiboDataIds = this.getWeiboDao().select(task.getWeiboId(), Task.TASK_TYPE_MY_FRIEND_WEIBO_CONTENT_COLLECT, null, ConstantParam.MONGODB_COMMENT);

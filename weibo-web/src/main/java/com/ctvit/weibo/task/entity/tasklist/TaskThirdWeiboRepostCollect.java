 ...
 *
 */
public class TaskThirdWeiboRepostCollect extends Task{
	...
	public void execute(JobExecutionContext context)
		...
		if(flag){
			//根据uid和抓取weiboId从mongodb中查询出未处理的微博数据
			List<String> weiboDataIds = this.getWeiboDao().select(task.getWeiboId(), Task.TASK_TYPE_THIRD_WEIBO_CONTENT_COLLECT, uid, ConstantParam.MONGODB_REPOST);

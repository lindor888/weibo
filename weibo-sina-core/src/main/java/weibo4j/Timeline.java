...
public class Timeline extends Weibo{
	 ...
	 * @throws WeiboException
	 */
	public StatusWapper getSearchLimited(String q,int startTime,int endTime,Paging paging) throws WeiboException{
		return Status.constructWapperStatus(client.get(
				WeiboConfig.getValue("businessUrl") + "search/statuses/limited.json",
				new PostParameter[] {
	 ...
	 * @throws WeiboException
	 */
	public JSONObject uploadPic(ImageItem item) throws WeiboException{
		return client.multPartURL(
				WeiboConfig.getValue("baseURL") + "statuses/upload_pic.json",
				new PostParameter[]{},item).asJSONObject();
	}
}

...
public class OAuthV2 extends OAuth implements Serializable{
    ...
    private String redirectUri = "http://www.ctvit.com.cn";// 授权回调地址
    private String clientId = "801476799";// 申请应用时分配的app_key
    private String clientSecret="39aa77c87cd1d93e9430fd543708f7da";//申请应用时分配到的app_secret
